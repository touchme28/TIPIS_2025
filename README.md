...
## Лабораторная 4
Код расположен в файле "Homework_4"  
Решили задачу бинарной классификации на примере банковского датасета. Ответы на вопросы в файле.
## Лабораторная 5
Код расположен в файле "Homework_5"  
Решили задачу предсказания оценки студентов. Ответы на вопросы в файле.
