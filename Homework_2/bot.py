...
async def start_command(message: Message):
    ...
    await message.answer(
        ...
        "🤖 <b>Использую:</b> Nvidia nemotron-nano-9b-v2\n\n",
...
async def help_command(message: Message):
    ...
    await message.answer(
        ...
        "• Оформление работы\n\n"
        "<b>💡 Результат:</b> Оценка из 25 баллов + рекомендации",
        reply_markup=get_main_keyboard()
    )
...
async def handle_document(message: Message):
    ...
    try:
        ...
        await status_msg.edit_text(
            ...
            f"🤖 <b>Модель:</b> nvidia/nemotron-nano-9b-v2:free"
        )
...
КРИТЕРИИ ОЦЕНКИ (25 баллов максимум):
1. Качество кода и решения (0-5 баллов)
2. Полнота и правильность реализации (0-5 баллов)  
3. Документация и комментарии (0-5 баллов)
4. Оформление и структура работы (0-5 баллов)
5. Качество проделанной работы и выводов (0-5 баллов)
...
- Поставь итоговую оценку из 25 баллов
...
async def main():
    ...
    print("🤖 ИИ модель: nvidia/nemotron-nano-9b-v2:free")
